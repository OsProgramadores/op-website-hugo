...
Comumente, direcionamos as pessoas aos artigos introdutórios como o [Ola Mundo]({{< ref "/blog/ola-mundo.md" >}} ) e na sequência, também encaminhamo-nas para o [desafio 01](https://osprogramadores.com/desafios/d01/).
...
Por mais tentador que seja, não indicamos que você mergulhe a fundo na documentação de cada um dos comandos apresentados neste artigo, por enquanto.
