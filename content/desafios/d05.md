...
Feito isto, utilize a linguagem de programação de sua preferência (e quaisquer bibliotecas que
sejam necessárias) e escreva um programa que leia o nome de um arquivo JSON como parâmetro -- que seguirá os mesmos moldes do arquivo `funcionarios.json` listado acima -- e imprima as informações solicitadas a seguir, baseado no conteúdo do arquivo lido.
