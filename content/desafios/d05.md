...
Para obter o valor do MD5, no linux, faça o seguinte: 

```
<PROGRAMA> <ARQUIVO DE TESTE> | /usr/bin/sort | /usr/bin/md5sum 
```
...
| [50K Registros](http://www.bcampos.com/Funcionarios-10K.json.7z)	    | 1c25b8e3d52ff9ae5ec9883570c49d59 |
...
Após ser validado você pode conferir o desempenho de seu código [nesta página](https://www.bcampos.com/Graphs.php).
