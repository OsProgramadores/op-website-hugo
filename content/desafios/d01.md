...
0. Recomendamos que você [assista este tutorial sobre git](https://www.youtube.com/watch?v=P7TEoH7nJW0) antes de passar para o próximo passo. Caso você use Windows, leia as instruções de instalação [neste artigo](https://dicasdeprogramacao.com.br/como-instalar-o-git-no-windows/). A documentação oficial do Git em português está disponível no [site do Git](https://git-scm.com/docs/git/pt_BR).
