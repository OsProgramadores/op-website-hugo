...
Um anagrama é uma palavra ou frase formada com o re-arranjo de todas as letras de uma outra palavra ou frase. A palavra *barco* por exemplo, é um anagrama para a palavra *cobra* (e vice-versa).
